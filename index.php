...
<header>
    ...
    <div id="menu-bar" class="fas fa-bars" onclick="toggle()"></div>
    
    <nav class="navbar">
        <a style="--i:0;" href="#home">home</a>
        <a style="--i:1;" href="#feature">feature</a>
        <a style="--i:2;" href="services.html">service</a>
        ...
        <a style="--i:7;" href="registration.html" target="_blank">Registration</a>
        <a style="--i:8;" href="#login">login</a>
    </nav>
...
<div class="container">
    ...
    <div class="box-container">
        ...
        <div class="container view-more-btn">
...
<section class="about" id="about">
    ...
    <h1>About Us!</h1>
    <h3 style="text-align: center;">Welcome To <span id="W_Name1">service</span></h3>
    <p>Hello Everyone ,welcome to our website CSCdoc. Now a days in the village areas most of the people are uneducated and don’t have so much knowledge about online services and documents. So they have to visit the nearest Service centre and Computer centres, where they face several problems and feel hagitate to visit the shop. So keeping in mind that concept we have launched our website, where they don’t have to visit the shop our delivery agent will provide document pickup and document delivery facilities without any extra charge. And also our customer can apply for the services they want through our website. Our website is simply designed and user friendly. All they have to do is just fill-up their details and pay the service fee. That’s all. The service will be delivered to their doorstep after the Processing time.</p>
...
<div class="footer">
    ...
    <h1 class="credit"> &copy; copyright by <a href="https://mizanuralrasid.github.io/Mizanuralrasid/">mizanur alrasid</a> @ 2021 </h1>
